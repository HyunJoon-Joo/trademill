...
export class GameScene extends Phaser.Scene {
    ...
    createHud() {
        ...
        this.marketInfoText = createNacreText(this, 24, 77, 'MARKET: loading...', {
            fontFamily: VISUAL_THEME.text.monoFont,
            fontSize: '15px',
        ...
        this.infoText = createNacreText(
            ...
            24,
            102,
            'RIGHT tap/hold: climb / LEFT tap: brake / LEFT hold: reverse / DOWN: grip / G: give up / M: menu',
            {
