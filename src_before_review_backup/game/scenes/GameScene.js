...
export class GameScene extends Phaser.Scene {
    ...
    createHud() {
        ...
        this.infoText = this.add.text(
            24,
            104,
            'RIGHT tap/hold: climb / LEFT tap: brake / LEFT hold: reverse / DOWN: grip / SPACE or UP: jump',
            {
                fontFamily: 'Arial',
                fontSize: '17px',
                color: '#cbd5e1',
    ...
    */
    ...
    applyOptionalGroundAdhesion() {
        ...
        if (
            ...
            this.time.now < this.jumpDetachUntil
        ) {
            return;
        }
    ...
    */
    buildGroundFromMarketData() {
        ...
        const overlap = GAME_TUNING.terrain.segmentOverlap;
    ...
    handleInput(dt) {
        ...
        const canJump =
            grounded &&
            !(
                PLAYER_TUNING.jump.disableJumpWhileDownHeld &&
                downHeld
            );
        const jumpTapped =
        ...
        if (jumpTapped && canJump) {
            ...
            this.groundContactIds.clear();
            this.lastGroundedAt = Number.NEGATIVE_INFINITY;
            this.jumpDetachUntil =
                this.time.now + PLAYER_TUNING.jump.detachGraceMs;
            this.beginAirborneTracking();
        }
    }
